...
function Photography({ data, location }) {
    ...
    return (
        ...
        <div className="aboutme-page">
            ...
            <Link className="link" style={{ color: 'black' }} to="/blog/my-photography/en"><h2>Next Section</h2></Link>
            <Link className="link" style={{ color: 'black' }} to="/blog/moment-of-the-month/en"><h2>Previous Section</h2></Link>
