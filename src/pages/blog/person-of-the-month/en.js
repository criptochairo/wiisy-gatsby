    ...
    return (
        ...
        <div className="aboutme-page">
            ...
            <React.Fragment>
              ...
              <button id='button-55' className="toggleIntro" onClick={() => setShowText(!showText)}><strong>{buttonText}</strong></button>
            </React.Fragment>
          ...
          <button id='button-55' aria-label="previous-section"><Link className="link" style={{ color: 'black', width: '15rem' }} to="/blog/moment-of-the-month/en"><h2>Previous Section</h2></Link></button>
        </div> 
    </div>
    </Layout>
