        ...
        <div className="aboutme-page">
            ...
            <React.Fragment>
              ...
              <button onClick={() => setShowText(!showText)}><u><strong>{buttonText}</strong></u></button>
                ...
                <Link className="link" style={{ color: 'black' }} to="/blog/projects-with-my-daughter/en"><h2>Next Section</h2></Link>
                <Link className="link" style={{ color: 'black' }} to="/blog/my-podcast/en"><h2>Previous Section</h2></Link>
