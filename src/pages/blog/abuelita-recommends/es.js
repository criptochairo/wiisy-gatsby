...
function Photography({ data, location }) {
    ...
    return (
        ...
        <div className="aboutme-page">
          ...
          <button id='button-55' aria-label="next-section"><Link className="link" style={{ color: 'black', width: '15rem' }} to="/blog/moment-of-the-month/es"><h2>Siguiente sección</h2></Link></button>
