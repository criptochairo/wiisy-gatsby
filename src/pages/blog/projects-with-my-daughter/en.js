    ...
    return (
        ...
        <div className="aboutme-page">
            ...
            <h1>Projects with My Daughter</h1> <br />
                ...
                <Link className="link" style={{ color: 'black' }} to="/blog/my-sisters-advice/en"><h2>Next Section</h2></Link>
                <Link className="link" style={{ color: 'black' }} to="/blog/my-book/en"><h2>Previous Section</h2></Link>
