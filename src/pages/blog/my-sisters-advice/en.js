    ...
    return (
        ...
        <div className="aboutme-page">
            ...
            <h1>My Sister's Advice</h1> <br />
                ...
                <Link className="link" style={{ color: 'black' }} to="/blog/abuelita-recommends/en"><h2>Next Section</h2></Link>
                <Link className="link" style={{ color: 'black' }} to="/blog/projects-with-my-daughter/en"><h2>Previous Section</h2></Link>
