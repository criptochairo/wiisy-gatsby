    ...
    return (
        ...
        <div className="aboutme-page">
            ...
            <h1>Consejos de mi hermana</h1> <br />
                ...
                <Link className="link" style={{ color: 'black' }} to="/blog/abuelita-recommends/es"><h2>Siguiente sección</h2></Link>
                <Link className="link" style={{ color: 'black' }} to="/blog/projects-with-my-daughter/es"><h2>Sección anterior</h2></Link>
