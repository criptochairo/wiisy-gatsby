    ...
    return (
        <div id="content-page">
            ...
            <div className="title-container" id="header">
                <Link style={{ color: 'black' }} to="/"><StaticImage src="../images/Resources/Icons/united-states.png" alt="us-flag" id="flag"/></Link>
            </div>

            
            <div className="section-container">
                <Link to="/what-if-i-say-yes/es"><StaticImage src="../images/Resources/Icons/logo-final-es.jpg" alt="wiisy" /></Link>
            ...
            <div className="section-container">
                <Link to="/about-me/es"><StaticImage src="../images/Resources/Pics/210.JPEG" alt="about-me" /></Link>
            ...
            <div className="section-container">
                <Link to="/blog/es"><StaticImage src="../images/Resources/Pics/503.jpg" alt="blog" /></Link>
            ...
            <div className="section-container">
                <Link to="/community/es"><StaticImage src="../images/Resources/Pics/544.JPEG" alt="community-board" /></Link>
            ...
            <div className="section-container" id="contact-me">
                <Link to="/contact/es"><StaticImage src="../images/Resources/Pics/181.JPEG" alt="contact-me" /></Link>
